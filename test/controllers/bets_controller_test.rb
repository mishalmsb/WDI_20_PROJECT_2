...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { game_id: @bet.game_id, status: @bet.status, user_id: @bet.user_id, user_two_id: @bet.user_two_id, value: @bet.value }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { game_id: @bet.game_id, status: @bet.status, user_id: @bet.user_id, user_two_id: @bet.user_two_id, value: @bet.value }
    assert_redirected_to bet_path(assigns(:bet))
  end
